(() => {
  ...
  const en = {
    ...
    "notes.intercept.tackleIntro": "When a tackle or Force Shoot is intercepted by a weapon with overlapping range, the target takes reduced damage and the attacker takes recoil damage.",
    ...
    "notes.intercept.recoilNote": "Recoil is clamped to 25–115. If it destroys the attacker, tackle damage to the target becomes zero. It does not occur without interception or outside the interceptor's range.",
