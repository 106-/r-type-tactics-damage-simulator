(() => {
  ...
  const en = {
    ...
    "notes.nav.weaponKinds": "04 Attack weapon types",
    "notes.nav.terrain": "05 Terrain",
    "notes.nav.intercept": "06 Interception",
    "notes.nav.seize": "07 Capture",
    "notes.nav.special": "08 Miscellaneous",
    ...
    "notes.affinity.unitTypesTitle": "Unit types",
    "notes.affinity.unitTypesIntro": "The game defines 17 unit types corresponding to attribute.",
    "notes.affinity.unitTypeDisplay": "Simulator label",
    "notes.affinity.unitTypeExamples": "Representative units",
    "notes.affinity.unitTypeName1": "Mechanical units and flagships",
    "notes.affinity.unitTypeExamples1": "ARROW-HEAD, HEIMDALL, KOMBILER, BOLDO",
    "notes.affinity.unitTypeName2": "Mechanical parts",
    "notes.affinity.unitTypeExamples2": "BRIDGE SECTION, FRAGARACH CANNON, KOMBILER LASER",
    "notes.affinity.unitTypeName3": "Surface ships",
    "notes.affinity.unitTypeExamples3": "EGIR, RAHN, HIMINGLAVA",
    "notes.affinity.unitTypeName4": "Submersible mechanical units",
    "notes.affinity.unitTypeExamples4": "FROGMAN, SEA TIGER, GRANVIA F/M",
    "notes.affinity.unitTypeName5": "Wall-mounted mechanical units",
    "notes.affinity.unitTypeExamples5": "CORBETT DEFENSE TURRET / ANTI-AIR TURRET",
    "notes.affinity.unitTypeName6": "Ground mechanical units",
    "notes.affinity.unitTypeExamples6": "ALL-PURPOSE TANK, PISTAPH, BERRY series",
    "notes.affinity.unitTypeName7": "Biological units",
    "notes.affinity.unitTypeExamples7": "GAUPER, Bydo fighters, Forces",
    "notes.affinity.unitTypeName8": "Large biological units and flagships",
    "notes.affinity.unitTypeExamples8": "NOZARI, DOBKERATOPS, BERMATE",
    "notes.affinity.unitTypeName9": "Biological parts",
    "notes.affinity.unitTypeExamples9": "DOBKERATOPS parts, BERMATE BERYL LEAF, MOORA parts",
    "notes.affinity.unitTypeName10": "Aquatic lifeforms",
    "notes.affinity.unitTypeExamples10": "LEIDI",
    "notes.affinity.unitTypeName13": "Floating biological units",
    "notes.affinity.unitTypeExamples13": "GUSTERNET, GUSTERNET VARIANT, BARACCUS",
    "notes.affinity.unitTypeName14": "Wall-mounted biological units",
    "notes.affinity.unitTypeExamples14": "NEWT",
    "notes.affinity.unitTypeName16": "Space/water biological units",
    "notes.affinity.unitTypeExamples16": "BREAMS",
    "notes.affinity.unitTypeName17": "Rocks and structures",
    "notes.affinity.unitTypeExamples17": "SKYSCRAPER, rock formations, SHIP'S WRECKAGE",
    "notes.affinity.unitTypeName18": "Ice",
    "notes.affinity.unitTypeExamples18": "Ice floes, floating ice, ice pillars",
    "notes.affinity.unitTypeName19": "Anomalous entities",
    "notes.affinity.unitTypeExamples19": "GRIDLOCK series, AMBER PUPIL, Xelf-24",
    "notes.affinity.unitTypeName20": "Anomalous entity parts",
    "notes.affinity.unitTypeExamples20": "GRIDLOCK EYE",

    "notes.weaponKinds.title": "Attack weapon types",
    "notes.weaponKinds.intro": "Weapons have three independent settings: displayed classification, attack behavior, and damage attribute.",
    "notes.weaponKinds.typeCard": "Displayed class",
    "notes.weaponKinds.typeCardDesc": "Machine gun, linear optical, guided missile, etc.",
    "notes.weaponKinds.motionCard": "Attack behavior",
    "notes.weaponKinds.motionCardDesc": "Straight, curved, area, tackle, etc.",
    "notes.weaponKinds.materialCard": "Damage attribute",
    "notes.weaponKinds.materialCardDesc": "Optical, mechanical, biological, particle, etc.",
    "notes.weaponKinds.typeTitle": "Type — in-game weapon classification",
    "notes.weaponKinds.typeIntro": "Type is the classification shown on the weapon screen. It does not directly choose the affinity multiplier and is stored separately from Motion and Material.",
    "notes.weaponKinds.classification": "Classification",
    "notes.weaponKinds.examples": "Representative weapons",
    "notes.weaponKinds.type0": "Machine Gun",
    "notes.weaponKinds.typeExamples0": "VULCAN, ANTI-AIR GUN, BYDO BULLET",
    "notes.weaponKinds.type1": "Linear Optical Weapon",
    "notes.weaponKinds.typeExamples1": "ANTI-AIR LASER, SHOTGUN LASER, XPS LASER",
    "notes.weaponKinds.type2": "Vector Optical Weapon",
    "notes.weaponKinds.typeExamples2": "REFLECTION LASER, SEARCH LASER, HOMING BEAM",
    "notes.weaponKinds.type3": "Linear Missile",
    "notes.weaponKinds.typeExamples3": "DEPTH CHARGE, BYDO POLLUTANT",
    "notes.weaponKinds.type4": "Guided Missile",
    "notes.weaponKinds.typeExamples4": "HOMING MISSILE, LARGE GUIDED MISSILE, OCULOIDS",
    "notes.weaponKinds.type5": "Optical Melee Weapon",
    "notes.weaponKinds.typeExamples5": "BEAM SWORD, BEAM RUSH, GAINS CLAW",
    "notes.weaponKinds.type6": "Ram",
    "notes.weaponKinds.typeExamples6": "RAM, FORCE SHOOT, FINE ATTACK",
    "notes.weaponKinds.type7": "Bydo Fluid",
    "notes.weaponKinds.typeExamples7": "BYDO FLUID, HIGH-DENSITY BYDO FLUID",
    "notes.weaponKinds.type8": "Piercing Optical Weapon",
    "notes.weaponKinds.typeExamples8": "MAIN GUN, TYPE-1000 ANTI-AIR LASER, ENHANCED GROUND LASER",
    "notes.weaponKinds.type9": "Particle Weapon",
    "notes.weaponKinds.typeExamples9": "WAVE CANNON, POSITRON CANNON, REFRACTIVE EXCAVATION LASER",
    "notes.weaponKinds.type10": "Fire Attack",
    "notes.weaponKinds.typeExamples10": "INFERNO, PLASMA FLAME, HEAT WAVE CANNON",
    "notes.weaponKinds.type11": "Physical Attack",
    "notes.weaponKinds.typeExamples11": "IVY ROD, PILE BUNKER, POD SHOOT",
    "notes.weaponKinds.type12": "Psionic Attack",
    "notes.weaponKinds.typeExamples12": "PSIONIC WAVE, SHOCK WAVE, PSY-BIT SHOOT",
    "notes.weaponKinds.type13": "Chemical Attack",
    "notes.weaponKinds.typeExamples13": "ACID SPRAY, SEXY WAVE CANNON, BYDO SPRAY",
    "notes.weaponKinds.type14": "Spacetime Wave",
    "notes.weaponKinds.typeExamples14": "SUBSPACE BUSTER, SUBSPACE SONAR, GRAVITY FIELD",
    "notes.weaponKinds.motionTitle": "Motion — attack path and targeting",
    "notes.weaponKinds.motionIntro": "Motion determines line of fire, attack area, and whether the evasion check is bypassed.",
    "notes.weaponKinds.motionMode": "Attack behavior",
    "notes.weaponKinds.behavior": "Behavior and examples",
    "notes.weaponKinds.motionStraight": "Straight",
    "notes.weaponKinds.motionStraightDesc": "Vulcans and anti-air lasers. They can be subject to partial cover when the other conditions are met.",
    "notes.weaponKinds.motionCurve": "Curved / guided",
    "notes.weaponKinds.motionCurveDesc": "Reflection lasers and guided missiles. They do not enter the partial-cover path used for straight attacks.",
    "notes.weaponKinds.motionMap": "Map area",
    "notes.weaponKinds.motionMapDesc": "Wave cannons, decoy explosions, mine explosions, and similar attacks. They bypass the normal evasion calculation.",
    "notes.weaponKinds.motionTackle": "Tackle",
    "notes.weaponKinds.motionTackleDesc": "Rams and Force Shoot. This path leads to knockback, collision bonuses, and recoil processing.",
    "notes.weaponKinds.motionRangeMap": "Ranged area",
    "notes.weaponKinds.motionRangeMapDesc": "Subspace Buster II. It selects an impact point using a normal range, then applies an area effect around it.",
    "notes.weaponKinds.motionDivide": "Divide",
    "notes.weaponKinds.motionDivideDesc": "Split Wave Cannon. Its attack area divides after impact, and it bypasses the normal evasion calculation.",
    "notes.weaponKinds.motionSelect": "Path selection",
    "notes.weaponKinds.motionSelectDesc": "Guided Wave Cannon. It uses a special selectable path and bypasses the normal evasion calculation.",
    "notes.weaponKinds.motionParts": "Linked parts",
    "notes.weaponKinds.motionPartsDesc": "Refractive Excavation Laser. Special handling links the main body and its bits as parent and child definitions.",
    "notes.weaponKinds.materialTitle": "Material — damage attribute",
    "notes.weaponKinds.materialIntro": "Material has eight values: optical, mechanical, biological, particle, flame, mental, ice, and acid. It is used for target affinity, terrain defense against optical attacks, and interception eligibility. See “03 Affinities” for the exact multipliers.",
    "notes.weaponKinds.exampleTitle": "Example — ARROW-HEAD weapons",
    "notes.weaponKinds.exampleWave": "<b>STANDARD WAVE CANNON:</b> Particle Weapon / Map area / Particle",
    "notes.weaponKinds.exampleAntiAir": "<b>ANTI-AIR LASER:</b> Linear Optical Weapon / Straight / Optical",
    "notes.weaponKinds.exampleReflect": "<b>REFLECTION LASER:</b> Vector Optical Weapon / Curved/Guided / Optical",
    ...
    "notes.intercept.recoilFormula": "Recoil = Attacker current HP × Interception rate × range factor (minimum 25, maximum 115)",
    "notes.intercept.recoilNote": "The range factor is 1.05 when the interception weapon's minimum range is 1, and 0.85 when it is 2 or greater. Recoil is clamped to 25–115. If it destroys the attacker, tackle damage to the target becomes zero.",
